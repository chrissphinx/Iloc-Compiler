...
public class LoadAOInstruction extends IlocInstruction
{
  private VirtualRegisterOperand[] virtRegs;

  public LoadAOInstruction(VirtualRegisterOperand vr1, VirtualRegisterOperand vr2, VirtualRegisterOperand vr3) {
    super();
