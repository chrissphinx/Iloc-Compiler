...
public class IlocParser implements IlocParserConstants {
  ...
  static final public IlocProgram program() throws ParseException {Vector<IlocInstruction> program;
...
{if ("" != null) return new IlocProgram(dataSection,program);}
    throw new Error("Missing return statement in function");
  }

  static final public DataSection data() throws ParseException {Vector<IlocInstruction> pseudoOps = new Vector<IlocInstruction>();
...
{if ("" != null) return new DataSection(pseudoOps);}
    throw new Error("Missing return statement in function");
  }

  static final public Vector<IlocInstruction> procedures() throws ParseException {Vector<IlocInstruction> proc;
...
{if ("" != null) return program;}
  ...
  static final public Vector<IlocInstruction> procedure() throws ParseException {IlocInstruction inst;
...
proc.insertElementAt(inst,0);
  ...
  static final public Vector<IlocInstruction> listOfIlocInstructions() throws ParseException {IlocInstruction inst;
...
{if ("" != null) return instList;}
    throw new Error("Missing return statement in function");
  }

  static final public FramePseudoOp frameInstruction() throws ParseException {Vector<VirtualRegisterOperand> vRegs = new Vector<VirtualRegisterOperand>();
...
frameOp = new FramePseudoOp(routineName.image,
            ...
            {if ("" != null) return frameOp;}
    throw new Error("Missing return statement in function");
  }

  static final public Vector<IlocInstruction> operationList() throws ParseException {Token name;
...
{if ("" != null) return operList;}
    throw new Error("Missing return statement in function");
  }

  static final public IlocInstruction operation() throws ParseException {VirtualRegisterOperand vr1,vr2,vr3;
...
inst = new AddIInstruction(vr1,
    ...
    case ANDI:{
      opc = jj_consume_token(ANDI);
      vr1 = virtualReg();
      jj_consume_token(COMMA);
      num = jj_consume_token(NUMBER);
      jj_consume_token(ASSIGN);
      vr3 = virtualReg();
inst = new AndIInstruction(vr1,
                        new ConstantOperand(Integer.parseInt(num.image)),
                        vr3);
      break;
      }
...
inst = new FcallInstruction(new LabelOperand(label.image),vRegs,vr3);
    ...
    case FCMP_LT:{
      opc = jj_consume_token(FCMP_LT);
      vr1 = virtualReg();
      jj_consume_token(COMMA);
      vr2 = virtualReg();
      jj_consume_token(ASSIGN);
      vr3 = virtualReg();
inst = new Fcmp_ltInstruction(vr1,vr2,vr3);
      break;
      }
    case FCMP_LE:{
      opc = jj_consume_token(FCMP_LE);
      vr1 = virtualReg();
      jj_consume_token(COMMA);
      vr2 = virtualReg();
      jj_consume_token(ASSIGN);
      vr3 = virtualReg();
inst = new Fcmp_leInstruction(vr1,vr2,vr3);
      break;
      }
    case FCMP_EQ:{
      opc = jj_consume_token(FCMP_EQ);
      vr1 = virtualReg();
      jj_consume_token(COMMA);
      vr2 = virtualReg();
      jj_consume_token(ASSIGN);
      vr3 = virtualReg();
inst = new Fcmp_eqInstruction(vr1,vr2,vr3);
      break;
      }
    case FCMP_NE:{
      opc = jj_consume_token(FCMP_NE);
      vr1 = virtualReg();
      jj_consume_token(COMMA);
      vr2 = virtualReg();
      jj_consume_token(ASSIGN);
      vr3 = virtualReg();
inst = new Fcmp_neInstruction(vr1,vr2,vr3);
      break;
      }
    case FCMP_GT:{
      opc = jj_consume_token(FCMP_GT);
      vr1 = virtualReg();
      jj_consume_token(COMMA);
      vr2 = virtualReg();
      jj_consume_token(ASSIGN);
      vr3 = virtualReg();
inst = new Fcmp_gtInstruction(vr1,vr2,vr3);
      break;
      }
    case FCMP_GE:{
      opc = jj_consume_token(FCMP_GE);
      vr1 = virtualReg();
      jj_consume_token(COMMA);
      vr2 = virtualReg();
      jj_consume_token(ASSIGN);
      vr3 = virtualReg();
inst = new Fcmp_geInstruction(vr1,vr2,vr3);
      break;
      }
    case FCOMP:{
...
inst = new LshiftInstruction(vr1,vr2,vr3);
    ...
    case MALLOC:{
      opc = jj_consume_token(MALLOC);
      vr1 = virtualReg();
      jj_consume_token(ASSIGN);
      vr2 = virtualReg();
inst = new MallocInstruction(vr1,vr2);
      break;
      }
    case MOD:{
...
inst = new NotInstruction(vr1,vr3);
    ...
    case ORI:{
      opc = jj_consume_token(ORI);
      vr1 = virtualReg();
      jj_consume_token(COMMA);
      num = jj_consume_token(NUMBER);
      jj_consume_token(ASSIGN);
      vr3 = virtualReg();
inst = new OrIInstruction(vr1,
                        new ConstantOperand(Integer.parseInt(num.image)),
                        vr3);
      break;
      }
...
inst = new TestneInstruction(vr1,vr3);
    ...
    case XORI:{
      opc = jj_consume_token(XORI);
      vr1 = virtualReg();
      jj_consume_token(COMMA);
      num = jj_consume_token(NUMBER);
      jj_consume_token(ASSIGN);
      vr3 = virtualReg();
inst = new XorIInstruction(vr1,
                        new ConstantOperand(Integer.parseInt(num.image)),
                        vr3);
      break;
      }
    case XOR:{
      opc = jj_consume_token(XOR);
      vr1 = virtualReg();
      jj_consume_token(COMMA);
      vr2 = virtualReg();
      jj_consume_token(ASSIGN);
      vr3 = virtualReg();
inst = new XorInstruction(vr1,vr2,vr3);
      break;
      }
    default:
      jj_la1[12] = jj_gen;
...
inst.setSourceLine(opc.beginLine);
  ...
  static final public IlocInstruction pseudoOp() throws ParseException {Token label,str,num,num1;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case STRING:{
...
{if ("" != null) return new StringPseudoOp(label.image,
...
{if ("" != null) return new FloatPseudoOp(label.image,Float.parseFloat(num.image));}
      break;
      }
    case GLOBAL:{
...
{if ("" != null) return new GlobalPseudoOp(label.image,
  ...
  static final public VirtualRegisterOperand virtualReg() throws ParseException {Token vr;
    vr = jj_consume_token(VR);
int vrNum = Integer.parseInt(vr.image.substring(3));
             IlocProgram.setMaxVirtualReg(vrNum);
             {if ("" != null) return new VirtualRegisterOperand(vrNum);}
    throw new Error("Missing return statement in function");
  }

  static final public ImmediateOperand immediateVal() throws ParseException {Token label,num;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LABEL:{
      label = jj_consume_token(LABEL);
{if ("" != null) return new LabelOperand(label.image);}
      break;
      }
    case NUMBER:{
      num = jj_consume_token(NUMBER);
{if ("" != null) return new ConstantOperand(Integer.valueOf(num.image));}
      break;
      }
    default:
      jj_la1[14] = jj_gen;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0xffffffc0,0x0,0x0,0x0,0xffffffc0,0xffffffc0,0x0,0x0,0x0,0x0,0x0,0xffffffc0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x10,0xfebfffff,0x400000,0x1000000,0x0,0xfebfffef,0xfebfffef,0x0,0x0,0x0,0x0,0x0,0xfebfffef,0x400000,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0xdffffffe,0x20000001,0x0,0x0,0xdffffffe,0xdffffffe,0x0,0x0,0x0,0x0,0x0,0xdffffffe,0x20000001,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x1087ff,0x0,0x0,0x100000,0x86ff,0x1086ff,0x20000,0x4000,0x20000,0x20000,0x20000,0x6ff,0x0,0x8100000,};
   }
